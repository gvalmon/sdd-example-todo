...
- Specs use **EARS** notation for requirements and **Given/When/Then** for behaviors. See `spec/CLAUDE.md` for the full format.

## Non-goals of this example

This is a canonical SDD example, not a production TODO app. It deliberately stays single-user, single-device, offline-only. See `spec/_constitution.md` § Non-Goals for the full list.
